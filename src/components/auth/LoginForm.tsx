  ...
  return (
    <div className="bg-gray-900/50 feature-card p-8 sm:p-12 rounded-2xl">
      <div className="max-w-md mx-auto">
        ...
        <p className="text-gray-400 mt-2 mb-8">Sign in to continue your personal growth journey.</p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="flex items-center justify-between !mt-4">
            <div className="flex items-center">
              ...
              <label htmlFor="remember" className="ml-2 text-sm text-gray-400">Keep me signed in</label>
            </div>
            <Link href="/reset-request" className="text-sm font-medium text-blue-400 hover:underline">
              Forgot password?
            </Link>
          </div>
