    ...
    return (
      <div className="bg-gray-900/50 feature-card p-8 sm:p-12 rounded-2xl">
        <div className="max-w-md mx-auto text-center">
          <h2 className="text-4xl font-bold text-gray-100">✉️ Check Your Email</h2>
          <p className="text-gray-400 mt-4">We&rsquo;ve sent a password reset link to your email address.</p>
          <p className="text-sm text-gray-500 my-6">The link will expire in 1 hour for your security.</p>
          ...
          <div className="mt-8 text-sm text-gray-400 space-y-2">
            ...
            <p>
              Need immediate help?{' '}
              <Link href="/help" className="font-medium text-blue-400 hover:underline">
                Contact Support
              </Link>
            </p>
          </div>
  ...
  return (
    <div className="bg-gray-900/50 feature-card p-8 sm:p-12 rounded-2xl">
      <div className="max-w-md mx-auto">
        <h2 className="text-4xl font-bold text-gray-100">Reset Your Password 🔑</h2>
        <p className="text-gray-400 mt-3 mb-8">Enter your email address and we&rsquo;ll send you a secure link to reset your password.</p>
