    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-3 grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <WidgetCard className="p-6 flex flex-col justify-center">
            ...
            <p className="text-sm font-semibold text-gray-300 mb-1">
              Progress: {summary?.completedToday || 0}/{summary?.totalCompletedToday || 0}
            </p>
            ...
            <Link href="/dashboard/habits" className="text-blue-400 font-semibold text-sm hover:underline">
              View All Habits
            </Link>
          </WidgetCard>
        </div>
          ...
          <WidgetCard className="p-6">
            ...
            {todaysHabits.length > 0 ? (
                ...
                {todaysHabits.map((habitProgress) => (
                  ...
                  >
                    <h4 className="font-bold text-gray-100 mb-2">
                      {habitProgress.habit.emoji || '📋'} {habitProgress.habit.title}
                    </h4>
                    {habitProgress.todayLog?.completed ? (
                      <div>
                      ...
                      <div>
                        ...
                        <Button 
                          ...
                          onClick={() => handleCompleteHabit(habitProgress.habit._id!, 1)}
              ...
              <div className="text-center py-8">
                ...
                <h4 className="font-semibold mb-2 text-gray-100">No habits for today</h4>
                <p className="text-gray-400 mb-4">Create your first habit to start tracking your progress</p>
                <Button 
                  onClick={() => setShowCreateForm(true)}
        ...
        <div className="xl:col-span-3 grid grid-cols-1 lg:grid-cols-5 gap-6">
          {/* Quick Journal Entry */}
          <WidgetCard className="p-6 lg:col-span-2">
            <h3 className="font-bold text-lg mb-4 text-gray-100">📝 Quick Journal Entry</h3>
          ...
          <WidgetCard className="p-6 lg:col-span-3">
            <h3 className="font-bold text-lg mb-4 text-gray-100">📊 Weekly Progress</h3>
            <div className="space-y-3 text-sm">
              {habits.length > 0 ? habits.slice(0, 4).map((habitProgress) => (
                <div key={habitProgress.habit._id}>
                  <div className="flex justify-between mb-1">
                    <span className="text-gray-300">{habitProgress.habit.title}</span>
                    <span className="font-semibold text-gray-200">{habitProgress.weeklyProgress.percentage}%</span>
                  </div>
                  <div className="w-full bg-white/10 rounded-full h-2">
                    <div 
                      className="bg-blue-500 h-2 rounded-full" 
                      style={{ width: `${habitProgress.weeklyProgress.percentage}%` }}
                    ></div>
                  </div>
                </div>
              )) : (
