      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center py-12 md:py-16">
        ...
        <div className="flex flex-col justify-center h-full">
          ...
          <p className="text-gray-400 mt-4 text-lg">
            Let's set up your personal growth journey in just a few simple steps.
          </p>
          
          <div className="space-y-4 my-8 text-gray-300">
            <p className="flex items-start gap-3 text-lg">
              🎯 <span className="text-gray-400">Set meaningful goals that align with your values</span>
            </p>
            <p className="flex items-start gap-3 text-lg">
              📊 <span className="text-gray-400">Track your progress with beautiful visualizations</span>
            </p>
            <p className="flex items-start gap-3 text-lg">
              🧠 <span className="text-gray-400">Reflect and grow through guided journaling</span>
            </p>
            <p className="flex items-start gap-3 text-lg">
              🏛️ <span className="text-gray-400">Discover wisdom from philosophers and thinkers</span>
            </p>
          </div>
          ...
          <div className="flex items-center gap-4 mt-6">
            ...
            >
              Let's Start <span className="font-normal text-blue-200">(2 minutes)</span>
            </Link>
        ...
        <div className="flex flex-col items-center justify-center gap-8 h-full">
          <div className="w-full max-w-md">
            <h3 className="text-xl font-bold text-gray-200 mb-4 text-center">Interactive Preview</h3>
            <div className="bg-white/[0.03] border border-blue-500/30 backdrop-blur-sm p-6 rounded-2xl shadow-2xl shadow-blue-500/10">
              <h4 className="font-bold text-lg text-gray-100 mb-4">📊 Your Future Dashboard</h4>
              <div className="space-y-3 text-gray-300">
                <p className="text-lg">Good morning! ☀️</p>
                <p><span className="font-semibold text-gray-200">Today's Habits:</span> ✓ ○ 📚</p>
                <p><span className="font-semibold text-gray-200">Journal:</span> "Today I practiced..."</p>
                <p><span className="font-semibold text-gray-200">Wisdom:</span> "The best time to..."</p>
                <div className="pt-2">
          ...
          <div className="text-center text-gray-400 space-y-3 max-w-md">
            <p>This is what your personalized dashboard will look like once you complete the setup!</p>
