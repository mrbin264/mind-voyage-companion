...
tools: ['changes', 'fetch', 'findTestFiles', 'githubRepo', 'problems', 'usages', 'edit', 'runNotebooks', 'search', 'new', 'runCommands', 'runTasks', 'vscodeAPI', 'think', 'testFailure', 'openSimpleBrowser', 'extensions', 'todos', 'add_issue_comment', 'create_issue', 'get_issue', 'list_issues', 'search_issues', 'update_issue']
---
